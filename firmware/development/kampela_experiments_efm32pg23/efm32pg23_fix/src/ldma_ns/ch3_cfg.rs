...
pub type SRCINCSIGN_W<'a, const O: u8> = crate::BitWriter<'a, u32, CH3_CFG_SPEC, SRCINCSIGN_A, O>;
...
pub type DSTINCSIGN_W<'a, const O: u8> = crate::BitWriter<'a, u32, CH3_CFG_SPEC, DSTINCSIGN_A, O>;
