...
pub struct R(crate::R<LESENSE_CH2OUTROUTE_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<LESENSE_CH2OUTROUTE_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<LESENSE_CH2OUTROUTE_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<LESENSE_CH2OUTROUTE_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `LESENSE_CH2OUTROUTE` writer"]
pub struct W(crate::W<LESENSE_CH2OUTROUTE_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<LESENSE_CH2OUTROUTE_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<LESENSE_CH2OUTROUTE_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<LESENSE_CH2OUTROUTE_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type PORT_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, LESENSE_CH2OUTROUTE_SPEC, u8, u8, 2, O>;
...
pub type PIN_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, LESENSE_CH2OUTROUTE_SPEC, u8, u8, 4, O>;
impl R {
...
#[doc = "CH2OUT port/pin select\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [lesense_ch2outroute](index.html) module"]
pub struct LESENSE_CH2OUTROUTE_SPEC;
impl crate::RegisterSpec for LESENSE_CH2OUTROUTE_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [lesense_ch2outroute::R](R) reader structure"]
impl crate::Readable for LESENSE_CH2OUTROUTE_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [lesense_ch2outroute::W](W) writer structure"]
impl crate::Writable for LESENSE_CH2OUTROUTE_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets LESENSE_CH2OUTROUTE to value 0"]
impl crate::Resettable for LESENSE_CH2OUTROUTE_SPEC {
