...
pub struct R(crate::R<USART0_ROUTEEN_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<USART0_ROUTEEN_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<USART0_ROUTEEN_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<USART0_ROUTEEN_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `USART0_ROUTEEN` writer"]
pub struct W(crate::W<USART0_ROUTEEN_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<USART0_ROUTEEN_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<USART0_ROUTEEN_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<USART0_ROUTEEN_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type CSPEN_W<'a, const O: u8> = crate::BitWriter<'a, u32, USART0_ROUTEEN_SPEC, bool, O>;
...
pub type RTSPEN_W<'a, const O: u8> = crate::BitWriter<'a, u32, USART0_ROUTEEN_SPEC, bool, O>;
...
pub type RXPEN_W<'a, const O: u8> = crate::BitWriter<'a, u32, USART0_ROUTEEN_SPEC, bool, O>;
...
pub type CLKPEN_W<'a, const O: u8> = crate::BitWriter<'a, u32, USART0_ROUTEEN_SPEC, bool, O>;
...
pub type TXPEN_W<'a, const O: u8> = crate::BitWriter<'a, u32, USART0_ROUTEEN_SPEC, bool, O>;
impl R {
...
pub struct USART0_ROUTEEN_SPEC;
impl crate::RegisterSpec for USART0_ROUTEEN_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [usart0_routeen::R](R) reader structure"]
impl crate::Readable for USART0_ROUTEEN_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [usart0_routeen::W](W) writer structure"]
impl crate::Writable for USART0_ROUTEEN_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets USART0_ROUTEEN to value 0"]
impl crate::Resettable for USART0_ROUTEEN_SPEC {
