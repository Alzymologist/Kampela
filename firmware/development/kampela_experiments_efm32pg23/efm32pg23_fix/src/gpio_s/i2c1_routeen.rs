...
pub type SCLPEN_W<'a, const O: u8> = crate::BitWriter<'a, u32, I2C1_ROUTEEN_SPEC, bool, O>;
...
pub type SDAPEN_W<'a, const O: u8> = crate::BitWriter<'a, u32, I2C1_ROUTEEN_SPEC, bool, O>;
impl R {
