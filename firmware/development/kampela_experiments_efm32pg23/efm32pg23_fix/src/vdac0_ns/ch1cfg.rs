...
pub struct R(crate::R<CH1CFG_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<CH1CFG_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<CH1CFG_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<CH1CFG_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `CH1CFG` writer"]
pub struct W(crate::W<CH1CFG_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<CH1CFG_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<CH1CFG_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<CH1CFG_SPEC>) -> Self {
        W(writer)
    }
}
...
#[doc = "No Description\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [ch1cfg](index.html) module"]
pub struct CH1CFG_SPEC;
impl crate::RegisterSpec for CH1CFG_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [ch1cfg::R](R) reader structure"]
impl crate::Readable for CH1CFG_SPEC {
    type Reader = R;
}
