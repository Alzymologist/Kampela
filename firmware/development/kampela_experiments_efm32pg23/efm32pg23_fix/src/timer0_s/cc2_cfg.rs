#[doc = "Register `CC2_CFG` reader"]
pub struct R(crate::R<CC2_CFG_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<CC2_CFG_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<CC2_CFG_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<CC2_CFG_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `CC2_CFG` writer"]
pub struct W(crate::W<CC2_CFG_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<CC2_CFG_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<CC2_CFG_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<CC2_CFG_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type MODE_W<'a, const O: u8> = crate::FieldWriterSafe<'a, u32, CC2_CFG_SPEC, u8, MODE_A, 2, O>;
...
pub type COIST_W<'a, const O: u8> = crate::BitWriter<'a, u32, CC2_CFG_SPEC, bool, O>;
...
pub type INSEL_W<'a, const O: u8> =
    crate::FieldWriterSafe<'a, u32, CC2_CFG_SPEC, u8, INSEL_A, 2, O>;
...
pub type PRSCONF_W<'a, const O: u8> = crate::BitWriter<'a, u32, CC2_CFG_SPEC, PRSCONF_A, O>;
...
pub type FILT_W<'a, const O: u8> = crate::BitWriter<'a, u32, CC2_CFG_SPEC, FILT_A, O>;
...
pub type ICFWL_W<'a, const O: u8> = crate::BitWriter<'a, u32, CC2_CFG_SPEC, bool, O>;
impl R {
...
#[doc = "No Description\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [cc2_cfg](index.html) module"]
pub struct CC2_CFG_SPEC;
impl crate::RegisterSpec for CC2_CFG_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [cc2_cfg::R](R) reader structure"]
impl crate::Readable for CC2_CFG_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [cc2_cfg::W](W) writer structure"]
impl crate::Writable for CC2_CFG_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets CC2_CFG to value 0"]
impl crate::Resettable for CC2_CFG_SPEC {
