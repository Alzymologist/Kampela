...
pub type MODE_W<'a, const O: u8> = crate::FieldWriterSafe<'a, u32, CC0_CFG_SPEC, u8, MODE_A, 2, O>;
...
pub type COIST_W<'a, const O: u8> = crate::BitWriter<'a, u32, CC0_CFG_SPEC, bool, O>;
...
pub type INSEL_W<'a, const O: u8> =
    crate::FieldWriterSafe<'a, u32, CC0_CFG_SPEC, u8, INSEL_A, 2, O>;
...
pub type PRSCONF_W<'a, const O: u8> = crate::BitWriter<'a, u32, CC0_CFG_SPEC, PRSCONF_A, O>;
...
pub type FILT_W<'a, const O: u8> = crate::BitWriter<'a, u32, CC0_CFG_SPEC, FILT_A, O>;
...
pub type ICFWL_W<'a, const O: u8> = crate::BitWriter<'a, u32, CC0_CFG_SPEC, bool, O>;
impl R {
