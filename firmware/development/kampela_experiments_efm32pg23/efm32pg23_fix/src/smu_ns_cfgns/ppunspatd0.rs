...
pub type SCRATCHPAD_R = crate::BitReader<bool>;
#[doc = "Field `SCRATCHPAD` writer - SCRATCHPAD Privileged Access"]
pub type SCRATCHPAD_W<'a, const O: u8> = crate::BitWriter<'a, u32, PPUNSPATD0_SPEC, bool, O>;
...
pub type DCDC_W<'a, const O: u8> = crate::BitWriter<'a, u32, PPUNSPATD0_SPEC, bool, O>;
...
pub type HOSTMAILBOX_W<'a, const O: u8> = crate::BitWriter<'a, u32, PPUNSPATD0_SPEC, bool, O>;
...
pub type EUSART1_W<'a, const O: u8> = crate::BitWriter<'a, u32, PPUNSPATD0_SPEC, bool, O>;
...
pub type EUSART2_W<'a, const O: u8> = crate::BitWriter<'a, u32, PPUNSPATD0_SPEC, bool, O>;
impl R {
    #[doc = "Bit 0 - SCRATCHPAD Privileged Access"]
    #[inline(always)]
    pub fn scratchpad(&self) -> SCRATCHPAD_R {
        SCRATCHPAD_R::new((self.bits & 1) != 0)
    }
