...
pub struct R(crate::R<GRP0_IEN_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<GRP0_IEN_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<GRP0_IEN_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<GRP0_IEN_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `GRP0_IEN` writer"]
pub struct W(crate::W<GRP0_IEN_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<GRP0_IEN_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<GRP0_IEN_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<GRP0_IEN_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type OVF_W<'a, const O: u8> = crate::BitWriter<'a, u32, GRP0_IEN_SPEC, bool, O>;
...
pub type CMP0_W<'a, const O: u8> = crate::BitWriter<'a, u32, GRP0_IEN_SPEC, bool, O>;
...
pub type CMP1_W<'a, const O: u8> = crate::BitWriter<'a, u32, GRP0_IEN_SPEC, bool, O>;
...
pub type CAP0_W<'a, const O: u8> = crate::BitWriter<'a, u32, GRP0_IEN_SPEC, bool, O>;
impl R {
...
#[doc = "No Description\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [grp0_ien](index.html) module"]
pub struct GRP0_IEN_SPEC;
impl crate::RegisterSpec for GRP0_IEN_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [grp0_ien::R](R) reader structure"]
impl crate::Readable for GRP0_IEN_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [grp0_ien::W](W) writer structure"]
impl crate::Writable for GRP0_IEN_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets GRP0_IEN to value 0"]
impl crate::Resettable for GRP0_IEN_SPEC {
