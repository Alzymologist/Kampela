...
#[repr(u16)]
pub enum PCNTLOCKKEY_AW {
    #[doc = "42976: Write to unock PCNT lockable registers"]
    UNLOCK = 42976,
}
impl From<PCNTLOCKKEY_AW> for u16 {
    #[inline(always)]
    fn from(variant: PCNTLOCKKEY_AW) -> Self {
        variant as _
    }
}
#[doc = "Field `PCNTLOCKKEY` writer - Configuration Lock Key"]
pub type PCNTLOCKKEY_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, LOCK_SPEC, u16, PCNTLOCKKEY_AW, 16, O>;
impl<'a, const O: u8> PCNTLOCKKEY_W<'a, O> {
    #[doc = "Write to unock PCNT lockable registers"]
    #[inline(always)]
    pub fn unlock(self) -> &'a mut W {
        self.variant(PCNTLOCKKEY_AW::UNLOCK)
    }
}
impl W {
