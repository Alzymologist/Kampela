#[doc = "Register `HFRCODPLLCAL14` reader"]
pub struct R(crate::R<HFRCODPLLCAL14_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<HFRCODPLLCAL14_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<HFRCODPLLCAL14_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<HFRCODPLLCAL14_SPEC>) -> Self {
        R(reader)
    }
}
...
#[doc = "HFRCODPLL Calibration\n\nThis register you can [`read`](crate::generic::Reg::read). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [hfrcodpllcal14](index.html) module"]
pub struct HFRCODPLLCAL14_SPEC;
impl crate::RegisterSpec for HFRCODPLLCAL14_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [hfrcodpllcal14::R](R) reader structure"]
impl crate::Readable for HFRCODPLLCAL14_SPEC {
    type Reader = R;
}
#[doc = "`reset()` method sets HFRCODPLLCAL14 to value 0"]
impl crate::Resettable for HFRCODPLLCAL14_SPEC {
