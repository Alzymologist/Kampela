...
pub struct R(crate::R<HFRCODPLLCAL15_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<HFRCODPLLCAL15_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<HFRCODPLLCAL15_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<HFRCODPLLCAL15_SPEC>) -> Self {
        R(reader)
    }
}
...
#[doc = "HFRCODPLL Calibration\n\nThis register you can [`read`](crate::generic::Reg::read). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [hfrcodpllcal15](index.html) module"]
pub struct HFRCODPLLCAL15_SPEC;
impl crate::RegisterSpec for HFRCODPLLCAL15_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [hfrcodpllcal15::R](R) reader structure"]
impl crate::Readable for HFRCODPLLCAL15_SPEC {
    type Reader = R;
}
#[doc = "`reset()` method sets HFRCODPLLCAL15 to value 0"]
impl crate::Resettable for HFRCODPLLCAL15_SPEC {
