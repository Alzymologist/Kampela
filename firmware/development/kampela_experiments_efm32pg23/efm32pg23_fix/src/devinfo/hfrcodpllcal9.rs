#[doc = "Register `HFRCODPLLCAL9` reader"]
pub struct R(crate::R<HFRCODPLLCAL9_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<HFRCODPLLCAL9_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<HFRCODPLLCAL9_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<HFRCODPLLCAL9_SPEC>) -> Self {
        R(reader)
    }
}
...
#[doc = "HFRCODPLL Calibration\n\nThis register you can [`read`](crate::generic::Reg::read). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [hfrcodpllcal9](index.html) module"]
pub struct HFRCODPLLCAL9_SPEC;
impl crate::RegisterSpec for HFRCODPLLCAL9_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [hfrcodpllcal9::R](R) reader structure"]
impl crate::Readable for HFRCODPLLCAL9_SPEC {
    type Reader = R;
}
#[doc = "`reset()` method sets HFRCODPLLCAL9 to value 0"]
impl crate::Resettable for HFRCODPLLCAL9_SPEC {
