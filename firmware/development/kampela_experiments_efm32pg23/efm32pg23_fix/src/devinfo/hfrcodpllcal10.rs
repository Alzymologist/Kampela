#[doc = "Register `HFRCODPLLCAL10` reader"]
pub struct R(crate::R<HFRCODPLLCAL10_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<HFRCODPLLCAL10_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<HFRCODPLLCAL10_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<HFRCODPLLCAL10_SPEC>) -> Self {
        R(reader)
    }
}
...
#[doc = "HFRCODPLL Calibration\n\nThis register you can [`read`](crate::generic::Reg::read). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [hfrcodpllcal10](index.html) module"]
pub struct HFRCODPLLCAL10_SPEC;
impl crate::RegisterSpec for HFRCODPLLCAL10_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [hfrcodpllcal10::R](R) reader structure"]
impl crate::Readable for HFRCODPLLCAL10_SPEC {
    type Reader = R;
}
