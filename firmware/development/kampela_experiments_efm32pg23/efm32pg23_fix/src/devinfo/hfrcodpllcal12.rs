#[doc = "Register `HFRCODPLLCAL12` reader"]
pub struct R(crate::R<HFRCODPLLCAL12_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<HFRCODPLLCAL12_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<HFRCODPLLCAL12_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<HFRCODPLLCAL12_SPEC>) -> Self {
        R(reader)
    }
}
...
pub struct HFRCODPLLCAL12_SPEC;
impl crate::RegisterSpec for HFRCODPLLCAL12_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [hfrcodpllcal12::R](R) reader structure"]
impl crate::Readable for HFRCODPLLCAL12_SPEC {
    type Reader = R;
}
#[doc = "`reset()` method sets HFRCODPLLCAL12 to value 0"]
impl crate::Resettable for HFRCODPLLCAL12_SPEC {
