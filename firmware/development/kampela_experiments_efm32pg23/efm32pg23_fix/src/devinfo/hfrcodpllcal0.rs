#[doc = "Register `HFRCODPLLCAL0` reader"]
pub struct R(crate::R<HFRCODPLLCAL0_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<HFRCODPLLCAL0_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<HFRCODPLLCAL0_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<HFRCODPLLCAL0_SPEC>) -> Self {
        R(reader)
    }
}
...
#[doc = "HFRCODPLL Calibration\n\nThis register you can [`read`](crate::generic::Reg::read). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [hfrcodpllcal0](index.html) module"]
pub struct HFRCODPLLCAL0_SPEC;
impl crate::RegisterSpec for HFRCODPLLCAL0_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [hfrcodpllcal0::R](R) reader structure"]
impl crate::Readable for HFRCODPLLCAL0_SPEC {
    type Reader = R;
}
#[doc = "`reset()` method sets HFRCODPLLCAL0 to value 0"]
impl crate::Resettable for HFRCODPLLCAL0_SPEC {
