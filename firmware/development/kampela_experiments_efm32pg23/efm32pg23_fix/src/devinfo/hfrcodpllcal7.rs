#[doc = "Register `HFRCODPLLCAL7` reader"]
pub struct R(crate::R<HFRCODPLLCAL7_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<HFRCODPLLCAL7_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<HFRCODPLLCAL7_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<HFRCODPLLCAL7_SPEC>) -> Self {
        R(reader)
    }
}
...
#[doc = "HFRCODPLL Calibration\n\nThis register you can [`read`](crate::generic::Reg::read). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [hfrcodpllcal7](index.html) module"]
pub struct HFRCODPLLCAL7_SPEC;
impl crate::RegisterSpec for HFRCODPLLCAL7_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [hfrcodpllcal7::R](R) reader structure"]
impl crate::Readable for HFRCODPLLCAL7_SPEC {
    type Reader = R;
}
#[doc = "`reset()` method sets HFRCODPLLCAL7 to value 0"]
impl crate::Resettable for HFRCODPLLCAL7_SPEC {
