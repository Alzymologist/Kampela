#[doc = "Register `HFRCOEM23CAL2` reader"]
pub struct R(crate::R<HFRCOEM23CAL2_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<HFRCOEM23CAL2_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<HFRCOEM23CAL2_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<HFRCOEM23CAL2_SPEC>) -> Self {
        R(reader)
    }
}
...
#[doc = "HFRCOEM23 Calibration\n\nThis register you can [`read`](crate::generic::Reg::read). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [hfrcoem23cal2](index.html) module"]
pub struct HFRCOEM23CAL2_SPEC;
impl crate::RegisterSpec for HFRCOEM23CAL2_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [hfrcoem23cal2::R](R) reader structure"]
impl crate::Readable for HFRCOEM23CAL2_SPEC {
    type Reader = R;
}
#[doc = "`reset()` method sets HFRCOEM23CAL2 to value 0"]
impl crate::Resettable for HFRCOEM23CAL2_SPEC {
