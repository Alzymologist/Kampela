#[doc = "Register `HFRCOEM23CAL1` reader"]
pub struct R(crate::R<HFRCOEM23CAL1_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<HFRCOEM23CAL1_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<HFRCOEM23CAL1_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<HFRCOEM23CAL1_SPEC>) -> Self {
        R(reader)
    }
}
...
#[doc = "HFRCOEM23 Calibration\n\nThis register you can [`read`](crate::generic::Reg::read). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [hfrcoem23cal1](index.html) module"]
pub struct HFRCOEM23CAL1_SPEC;
impl crate::RegisterSpec for HFRCOEM23CAL1_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [hfrcoem23cal1::R](R) reader structure"]
impl crate::Readable for HFRCOEM23CAL1_SPEC {
    type Reader = R;
}
