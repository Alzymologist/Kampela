#[doc = "Register `HFRCODPLLCAL17` reader"]
pub struct R(crate::R<HFRCODPLLCAL17_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<HFRCODPLLCAL17_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<HFRCODPLLCAL17_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<HFRCODPLLCAL17_SPEC>) -> Self {
        R(reader)
    }
}
...
#[doc = "HFRCODPLL Calibration\n\nThis register you can [`read`](crate::generic::Reg::read). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [hfrcodpllcal17](index.html) module"]
pub struct HFRCODPLLCAL17_SPEC;
impl crate::RegisterSpec for HFRCODPLLCAL17_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [hfrcodpllcal17::R](R) reader structure"]
impl crate::Readable for HFRCODPLLCAL17_SPEC {
    type Reader = R;
}
#[doc = "`reset()` method sets HFRCODPLLCAL17 to value 0"]
impl crate::Resettable for HFRCODPLLCAL17_SPEC {
