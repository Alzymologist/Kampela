...
pub struct R(crate::R<SCALE1_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<SCALE1_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<SCALE1_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<SCALE1_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `SCALE1` writer"]
pub struct W(crate::W<SCALE1_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<SCALE1_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<SCALE1_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<SCALE1_SPEC>) -> Self {
        W(writer)
    }
}
...
pub struct SCALE1_SPEC;
impl crate::RegisterSpec for SCALE1_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [scale1::R](R) reader structure"]
impl crate::Readable for SCALE1_SPEC {
    type Reader = R;
}
