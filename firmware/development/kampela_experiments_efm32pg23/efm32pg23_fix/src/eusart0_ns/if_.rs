...
#[doc = "Field `CSWU` reader - CS Wake-up Interrupt Flag"]
pub type CSWU_R = crate::BitReader<bool>;
#[doc = "Field `CSWU` writer - CS Wake-up Interrupt Flag"]
pub type CSWU_W<'a, const O: u8> = crate::BitWriter<'a, u32, IF_SPEC, bool, O>;
...
impl R {
    ...
    #[doc = "Bit 16 - CS Wake-up Interrupt Flag"]
    #[inline(always)]
    pub fn cswu(&self) -> CSWU_R {
        CSWU_R::new(((self.bits >> 16) & 1) != 0)
    }
