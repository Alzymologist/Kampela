...
#[doc = "WDOG Configuration Lock\n\nValue on reset: 44008"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
#[repr(u16)]
pub enum LOCKKEY_AW {
    #[doc = "0: Lock WDOG lockable registers"]
    LOCK = 0,
    #[doc = "44008: Unlock WDOG lockable registers"]
    UNLOCK = 44008,
}
...
#[doc = "Field `LOCKKEY` writer - WDOG Configuration Lock"]
...
impl W {
    #[doc = "Bits 0:15 - WDOG Configuration Lock"]
    #[inline(always)]
    #[must_use]
...
#[doc = "`reset()` method sets LOCK to value 0xabe8"]
impl crate::Resettable for LOCK_SPEC {
    const RESET_VALUE: Self::Ux = 0xabe8;
}
