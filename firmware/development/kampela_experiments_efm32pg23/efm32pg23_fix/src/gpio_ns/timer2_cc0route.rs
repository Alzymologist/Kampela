...
pub type PORT_W<'a, const O: u8> = crate::FieldWriter<'a, u32, TIMER2_CC0ROUTE_SPEC, u8, u8, 2, O>;
...
pub type PIN_W<'a, const O: u8> = crate::FieldWriter<'a, u32, TIMER2_CC0ROUTE_SPEC, u8, u8, 4, O>;
impl R {
