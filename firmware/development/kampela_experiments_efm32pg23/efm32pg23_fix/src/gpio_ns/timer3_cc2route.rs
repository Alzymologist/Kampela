...
pub type PORT_W<'a, const O: u8> = crate::FieldWriter<'a, u32, TIMER3_CC2ROUTE_SPEC, u8, u8, 2, O>;
...
pub type PIN_W<'a, const O: u8> = crate::FieldWriter<'a, u32, TIMER3_CC2ROUTE_SPEC, u8, u8, 4, O>;
impl R {
