...
pub struct R(crate::R<TX_PROT_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<TX_PROT_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<TX_PROT_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<TX_PROT_SPEC>) -> Self {
        R(reader)
    }
}
...
#[doc = "TX Protection register.\n\nThis register you can [`read`](crate::generic::Reg::read). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [tx_prot](index.html) module"]
pub struct TX_PROT_SPEC;
impl crate::RegisterSpec for TX_PROT_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [tx_prot::R](R) reader structure"]
impl crate::Readable for TX_PROT_SPEC {
    type Reader = R;
}
#[doc = "`reset()` method sets TX_PROT to value 0"]
impl crate::Resettable for TX_PROT_SPEC {
