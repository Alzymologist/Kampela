...
pub enum EN_A {
    #[doc = "0: Stops clocking and resets peripheral core logic."]
    DISABLE = 0,
    #[doc = "1: Enables clocking, and begins scanning if CFG.AUTOSTART is 0x1."]
    ENABLE = 1,
}
...
impl<'a, const O: u8> EN_W<'a, O> {
    #[doc = "Stops clocking and resets peripheral core logic."]
    #[inline(always)]
    pub fn disable(self) -> &'a mut W {
        self.variant(EN_A::DISABLE)
    }
    #[doc = "Enables clocking, and begins scanning if CFG.AUTOSTART is 0x1."]
    #[inline(always)]
