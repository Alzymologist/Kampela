...
pub struct R(crate::R<RET6_REG_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<RET6_REG_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<RET6_REG_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<RET6_REG_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `RET6_REG` writer"]
pub struct W(crate::W<RET6_REG_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<RET6_REG_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<RET6_REG_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<RET6_REG_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type RETREG_W<'a, const O: u8> = crate::FieldWriter<'a, u32, RET6_REG_SPEC, u32, u32, 32, O>;
impl R {
...
#[doc = "No Description\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [ret6_reg](index.html) module"]
